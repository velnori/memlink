...
- **DREAMS.md parsing** — OpenClaw Reader now reads DREAMS.md feel entries during reverse import. 20 previously-lost emotion memories recovered.
- Null-safe tags/domains in DREAMS parser
- Dedup by canonical ID in DREAMS parser
- Hex case sensitivity fix in DREAMS section regex

[1.0.2]: https://github.com/velnori/memlink/compare/v1.0.1...v1.0.2

## [1.0.1] — 2026-06-30

### Fixed

- `python -m memlink.cli` now works — added missing `__main__` block to cli.py

[1.0.1]: https://github.com/velnori/memlink/compare/v1.0.0...v1.0.1
